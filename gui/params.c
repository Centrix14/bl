...
double grid_thick = 1, grid_step = 5;
double point_r = 4;
...
char *params[] = {"ppm", "gfr", "gfg", "gfb", "gt", "pr", "br", "bg", "bb", "fr", "fg", "fb", "th", "sg", "gs"};
double *values[] = {&PIX_PER_MM, &grid_fg_red, &grid_fg_green, &grid_fg_blue, &grid_thick, &point_r, &bg_red, &bg_green, &bg_blue, &fg_red, &fg_green, &fg_blue, &thick, &show_grid, &grid_step};
